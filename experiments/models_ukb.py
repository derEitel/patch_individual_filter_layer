...
class ModelLiu(nn.Module):
    ...
    def __init__(self):
        ...
        self.Conv_2 = nn.Conv3d(15, 25, kernel_size=3, stride=1, padding=0)
        self.pool_2 = nn.MaxPool3d(kernel_size=2, stride=2, padding=0)

        self.Conv_3 = nn.Conv3d(25, 50, kernel_size=3, stride=1, padding=0)
        self.pool_3 = nn.MaxPool3d(kernel_size=3, stride=(2, 2, 3), padding=0)

        self.Conv_4 = nn.Conv3d(50, 50, kernel_size=3, stride=1, padding=(0, 1, 0))
